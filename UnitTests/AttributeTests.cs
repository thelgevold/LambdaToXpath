...
namespace UnitTests
{
    ...
    public class AttributeTests
    {
        ...
        {
            var xpath = CreateXpath.Where(e => e.ElementName == "td" && e.Attribute("id").Contains("_parent_child") && e.Attribute("class").Text == "class1");
        ...
        {
            var xpath = CreateXpath.Where(e => e.ElementName == "td" && e.Attribute("id").Contains("_parent_child"));
        ...
        {
            var xpath = CreateXpath.Where(e => e.ElementName == "td" && e.Attribute("id").Contains("_parent_child") == true && e.Attribute("class").Contains("myClass") == true);
        ...
        {
            var xpath = CreateXpath.Where(e => e.ElementName == "td" && e.Attribute("class").Text == "testClass");
        ...
        {
            var xpath = CreateXpath.Where(e => e.ElementName == "td" && e.Attribute("class").Text == "testClass" && e.Attribute("id").Text == "div1" && e.Attribute("data-test1").Text == "someData");
